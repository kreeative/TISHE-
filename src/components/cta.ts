...
export const ctaGlass =
  `${ctaBase} bg-white/15 border-white/30 text-[#FFF8F2] shadow-[0_1px_2px_rgba(0,0,0,0.15)] ` +
...
export const ctaGlassOnLight =
  `${ctaBase} bg-[#1a120c]/5 border-[#1a120c]/25 text-[#1a120c] shadow-[0_1px_2px_rgba(90,50,36,0.08)] ` +
  'hover:bg-[#1a120c]/10 hover:border-[#5A3224]/50 hover:shadow-[0_14px_32px_-12px_rgba(90,50,36,0.35)]'
