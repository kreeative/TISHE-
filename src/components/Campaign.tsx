...
export default function Campaign() {
  return (
    <section
      className="relative overflow-hidden text-[#1B1113] py-20 sm:py-24 px-5 sm:px-10 md:px-16 border-b border-[#5A3224]/10"
      style={{ background: 'radial-gradient(120% 140% at 15% 0%, #FFFDFA 0%, #FAF7F3 45%, #FBEEE1 100%)' }}
    >
      <div
